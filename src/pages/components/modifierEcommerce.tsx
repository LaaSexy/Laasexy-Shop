    ...
    return (
      <div key={_id} className="flex-1 h-full overflow-y-auto">
        <div className="max-h-[calc(100vh-100px)] sm:max-h-[calc(100vh-120px)]">
          <div className="">
            <h3 className="font-bold text-lg leading-8 text-gray-900 dark:text-white">
              ...
              {modifiers.map((item) => {
                ...
                return (
                  <Button
                    ...
                    className={`${
                      isSelected
                        ? ' border-violet-800 !font-semibold text-violet-800 mb-6 dark:border-none dark:bg-violet-700 dark:text-white dark:hover:!text-white'
                        : 'border-gray-400 text-gray-800 dark:border-gray-700 text-base font-normal mb-6'
                    } !rounded-full border bg-white hover:border-violet-700 hover:text-violet-800 dark:border dark:bg-slate-800 dark:text-white dark:hover:!border-gray-600 dark:hover:!text-white sm:px-6`}
                  >
